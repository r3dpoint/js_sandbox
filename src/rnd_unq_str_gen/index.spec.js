...
describe('when testing the random unique string module', function () {
  ...
  it('generates a unique and random string', function () {
    this.timeout(10000);
    let max = 1000000;
    let set = new Set();
    for (let i = 0; i < max; i++) {
  ...
  describe.only('when logging to the console', function () {
